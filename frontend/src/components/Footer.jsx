      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-8 h-8 bg-gradient-to-r from-green-500 to-blue-600 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold">T2C</span>
              </div>
              <span className="text-xl font-bold">Trash2Cash</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Connecting waste producers with recyclers to create a sustainable circular economy. 
              Turn your trash into cash and help save the planet.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <span className="text-gray-300 text-sm">Made with ❤️ for the environment</span>
          </div>
        </div>
      </div>
    </footer>
